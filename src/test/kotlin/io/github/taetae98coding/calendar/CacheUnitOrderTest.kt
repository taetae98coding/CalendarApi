...
import io.github.taetae98coding.calendar.cache.CacheUnit
import io.github.taetae98coding.calendar.cache.Granularity
import io.github.taetae98coding.calendar.cache.SourceApi
import io.github.taetae98coding.calendar.cache.oldestFirst
...
class CacheUnitOrderTest {
    ...
    fun `연 단위 API 는 구간에 월이 없다`() {
        ...
        assertEquals(53, SourceApi.NAGER_KOREA.periods(Config.years).size)
        assertEquals(53 * 12, SourceApi.KASI_REST_DE.periods(Config.years).size)
    }
}
